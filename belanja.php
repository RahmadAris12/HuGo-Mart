    ...
    <header id="header" class="header-area style-01 layout-03">
                <div class="top-bar right">
                    ...
                    <ul class="horizontal-menu">
                        <li><a href="login & register.php" class="login-link"><i class="biolife-icon icon-login"></i>Login/Register</a></li> 
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 padding-top-2px">
                        ...
                        <div class="live-info">
                            <p class="telephone"><i class="fa fa-phone" aria-hidden="true"></i><b class="phone-number">089518524224</b></p>
                            <p class="working-time">Senin - Jumat: 8:30am-7:30pm; Sabtu - Minggu: 9:30am-4:30pm</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <ul class="contact-lines">
                                    ...
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Phone: 089456123753</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
                                    ...
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">Hours: Senin - Sabtu ~ 07:30 am</b>
                                        </p>
                                    </li>
                                </ul>
                            </div>
