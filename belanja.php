                        ...
                        <div class="vertical-menu vertical-category-block">
                            ...
                            <div class="wrap-menu">
                                <ul class="menu clone-main-menu">
                                    <?php
                                    include "admin/koneksi.php";
                                    $kategori_result = mysqli_query($koneksi, "SELECT * FROM tb_ktg ORDER BY nm_kategori ASC");
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-9">
                        <section class="footer-item">
                            <a href="index.php" class="biolife-logo"><img src="assets/images/favicon.png"
                                    alt="biolife logo"><b style="font-size: 150% ; color: green;">Hugo-Mart</b></a>
