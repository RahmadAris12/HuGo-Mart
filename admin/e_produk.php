...
if (isset($_GET['id'])) {
    ...
    $query =($koneksi, "SELECT * FROM tb_produk WHERE id_produk = '$id_produk'");
...
if (isset($_POST['supdate'])) {
    ...
    if ($_FILES['gambar']['name'] != '') {
        ...
        if (lin_array($extension, $allowed_extensions)) {
    ...
    $query = mysqli_query($koneksi, "UPDATE tb_prosuk SET nm_produk-'$nm_produk', harga='$harga', stok='$stok',
    ket='$desk', id_ktg='$id_kategori', gambar='$imgnewfile' WHERE id_produk='$id_produk'");
    if ($query) {
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3 mt-2" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="nm_produk" name="nm_produk" placeholder="Masukkan Nama Produk" value="<?php echo $data['nm_produk']; ?>"
                                    required>
                                </div>
                                <div class="col-12">
                                    <label for="harga" class="form-label">Harga</label>
                                    <input type="number" class="form-control" id="harga" name="harga" placeholder="Masukkan Harga Produk"  value="<?php echo $data['harga']; ?>"
                                    required> required>
                                </div>
                                <div class="col-12">
                                    <label for="stok" class="form-label">Stok</label>
                                    <input type="number" class="form-control" id="stok" name="stok" placeholder="Masukkan Stok Produk"  value="<?php echo $data['stok']; ?>"
                                    required> required>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-control" id="id_ktg" name="id_ktg" required>
                                        ...
                                        while ($kategori = mysqli_fetch_array($query_kategori)) {
                                            $selected = ($kategori['id_ktg'] == $ktg['id_ktg']) ? 'selected' : '';
                                            echo "<option value='{$kategori['id_ktg']}' $selected>{$kategori['nm_kategori']}</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
