...
<head>
    ...
    <title>Hubungi Kami - Hugo-Mart</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="contact-info-container sm-margin-top-27px xs-margin-bottom-60px xs-margin-top-60px">
                            ...
                            <p class="frst-desc">
                               Ada pertanyaan atau ingin pesan? Hubungi kami kapan saja!, Kami siap melayani Anda dengan cepat dan ramah, Jangan ragu untuk menghubungi kami melalui telepon, email, atau kunjungi toko kami di alamat yang tertera di bawah ini. Kami akan segera merespons pertanyaan Anda dan membantu Anda dengan segala kebutuhan Anda. Terima kasih telah memilih Hugo-Mart sebagai mitra belanja Anda!
                            </p>
                            <ul class="addr-info">
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Alamat:</b>
                                        <p class="dsc">KJl. Raya Blora-Cepu Km 12, Blora, Jawa Tengah</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Telepon:</b>
                                        <p class="dsc">0895-1852-4224</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                        <b class="tie">Email:</b>
                                        <p class="dsc">rahmatari2018@gmail.com</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="if-item">
                                ...
                                <ul class="contact-lines">
                                    <li>
                                        <p class="info-item">
                                            ...
                                            <b class="desc">KJl. Raya Blora-Cepu Km 12, Blora, Jawa Tengah</b>
                                        </p>
                                    </li>
                                    <li>
                                        <p class="info-item">
